...
urlpatterns = [
    ...
    path('orders/<int:order_id>/confirm-delivery/', confirm_delivery_view, name='confirm_delivery'),

    # Receipt generation
    path( 'orders/<int:order_id>/generate-receipt/', generate_receipt_view, name='generate_receipt'),
